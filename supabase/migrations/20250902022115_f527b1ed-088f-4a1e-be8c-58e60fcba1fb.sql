...
-- Ensure knowledge tables allow public read access for RAG functionality
CREATE POLICY IF NOT EXISTS "Allow public read access to knowledge documents"
ON public.knowledge_documents
FOR SELECT
TO authenticated, anon, service_role
USING (true);

CREATE POLICY IF NOT EXISTS "Allow public read access to knowledge chunks"  
...
CREATE POLICY IF NOT EXISTS "Allow service role full access to knowledge documents"
ON public.knowledge_documents
FOR ALL
TO service_role
USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow service role full access to knowledge chunks"
ON public.knowledge_chunks  
FOR ALL
TO service_role
USING (true)
