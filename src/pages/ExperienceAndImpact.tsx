    ...
    <div className="animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <div className="bg-gradient-to-r from-brand-primary/10 to-brand-accent/10 p-6 rounded-lg border border-brand-accent/20">
          <h2 className="text-xl font-semibold text-brand-primary mb-4">Key Achievements</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-2xl font-bold text-brand-primary">$15M+</div>
              <div className="text-sm text-brand-secondary">Revenue Impact</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-brand-primary">70%</div>
              <div className="text-sm text-brand-secondary">Faster Deployments</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-brand-primary">85%</div>
              <div className="text-sm text-brand-secondary">Compliance Automation</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        {sections.map((section, index) => (
          <Link key={index} to={section.path} className="block">
            <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-105 focus:ring-2 focus:ring-brand-primary focus:outline-none h-full">
              ...
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-xl font-semibold text-brand-primary">{section.title}</h3>
                </div>
                ...
                <div className="bg-brand-accent/10 p-3 rounded-lg mb-4">
                  <p className="text-brand-primary font-medium text-sm">{section.highlight}</p>
                </div>
                
                <div className="w-full bg-brand-primary hover:bg-brand-primary/90 text-white rounded-md px-4 py-2 flex items-center justify-center transition-colors">
                  Explore Details
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
        <h2 className="text-xl font-semibold text-brand-primary mb-4">Impact Philosophy</h2>
