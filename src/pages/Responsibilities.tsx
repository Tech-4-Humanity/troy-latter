  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-lg mb-8">
        <p className="mb-6">
          I drive breakthrough initiatives while building a culture of rapid experimentation and measurable outcomes.
        </p>
      </div>
      ...
      <div className="space-y-8 mb-10">
        <h2 className="text-2xl font-semibold text-brand-primary">Demo or Die</h2>
        <div className="space-y-8">
          <div>
            <h3 className="font-medium text-xl text-brand-primary">Building Ecosystem Alliances</h3>
          ...
          <div>
            <h3 className="font-medium text-xl text-brand-primary">Thought Leadership That Resonates</h3>
            <p className="text-brand-secondary mt-2">
              Amplify innovation vision through strategic communications<br/>
          ...
          <div>
            <h3 className="font-medium text-xl text-brand-primary">Empowering Customer Champions</h3>
            <p className="text-brand-secondary mt-2">
