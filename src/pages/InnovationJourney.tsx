      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 gap-8">
          <LeadershipCard
            ...
            situation="Oracle was engaged by the Department of Defence to roll out a patient triage system for field hospitals - but there was no established framework to ensure it met the highest national-security and medical compliance standards."
            ...
            action={'I formed and led a joint working group with Oracle engineers, Defence policy officers and health regulators. We mapped out all compliance checkpoints - from data handling to model validation - then built a clear "Playbook." This guide aligned outputs to clinical protocols and security policies, trained operations teams through live simulations, and embedded automated compliance reviews into every deployment approval.'}
            outcome={'Within 3 months, the playbook was approved by both ASD and the health regulator. The triage system was safely deployed to 20 field units, cutting average patient assessment time by 35% and reducing medical backlog by 60%, all while passing every audit with zero findings - and securing a $2 M multi-year support contract.'}
          />
          ...
          <LeadershipCard
            ...
            action={'I formed and led a high-trust "Tiger Team" comprising AWS Solutions Architects, government disaster-management leads, telco engineers and social-media API specialists. We ran design-thinking workshops to map stakeholder needs, then built a prototype to broadcast multi-channel alerts via Twitter, Facebook and SMS. To bridge offline gaps, we powered up meshing satellite backhaul and integrated local radio gateways. We held live field drills with first responders, collecting real-time feedback and iterating daily in 24-hour sprints.'}
          ...
          <LeadershipCard
            ...
            situation="Oracle lacked a structured channel to onboard and scale high-growth startups on OCI - limiting pipeline and regional developer talent."
          ...
          <LeadershipCard
            ...
            situation="At Oracle, the Australian Defence Force relied on a legacy, paper-driven system to manage pay and travel allowances for 60,000 personnel - resulting in frequent reconciliation errors, delayed payments of up to six weeks, and low soldier morale."
            ...
            action={'I led a cross-disciplinary team of Oracle cloud engineers and defence IT specialists. We designed new systemts to ingested HR data, calculated entitlements, and triggered payments. We embedded set up an automated pipeline policy scans for each change. I presented the prototype at a national defence tech symposium, wrote the accompanying whitepaper, and built a financial model showing TCO and ROI.'}
