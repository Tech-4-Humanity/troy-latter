...
Worked across environments incorporating Microsoft, SAP, Oracle, Salesforce, ServiceNow, Workday, Atlassian, Snowflake, Databricks, Teradata, cloud platforms, integration services and long-established government legacy systems.
...
- Bachelor of Economics (Law / Industrial Relations) – University of Wollongong
...
- ITIL
- TOGAF / IT4IT foundations
- AWS Solutions Architect – Professional
- Microsoft, Azure, Google Cloud and Oracle Cloud credentials
- AI, Responsible AI, Data Privacy and Security credentials

## Governance, Advisory and Professional Memberships

- Advisory Member – Queensland Government AI Hub
- Committee Member – Standards Australia BCI and Robotics
- Former Board Member – ITSMF Australia

## Security Clearance

Previously attained AGSVA NV2 security clearance. Currently on hold while not aligned to a sponsoring agency and eligible for reactivation upon employment. Suitable for roles requiring Baseline or NV1 eligibility, subject to standard agency processes.
